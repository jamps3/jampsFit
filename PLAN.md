...
- [ ] **Workout Summary Sync**: The 2026-07 Dancing capture confirms live workout BPM arrives through standard `2A37` and is decoded. Find the packet/characteristic that carries workout mode, duration, and workout calories; those fields were not present in the attached unknown log.
